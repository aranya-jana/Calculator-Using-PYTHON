...
class Calculator:
    def __init__(self):
        ...
        self.window.config(bg=LIGHT_GRAY)
    ...
    def create_digit_buttons(self):
        for digit, grid_value in self.digits.items():
            ...
            button.config(highlightbackground=BORDER_COLOR, highlightthickness=1)
    ...
    def create_operator_buttons(self):
        ...
        for operator, symbol in self.operations.items():
            button = tk.Button(self.buttons_frame, text=symbol, bg=DARK_BUTTON_COLOR, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=DARK_BUTTON_COLOR, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2", bg=DARK_BUTTON_COLOR, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
    ...
    def create_plus_minus_button(self):
        button = tk.Button(self.buttons_frame, text="+/-", bg=DARK_BUTTON_COLOR, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
                           borderwidth=0, command=self.plus_minus)
        button.grid(row=4, column=3, sticky=tk.NSEW, padx=1, pady=1)
        button.config(highlightbackground=BORDER_COLOR, highlightthickness=1)
